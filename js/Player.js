...
//     // Score display (layout controlled by external CSS)
...
//     // Life bar setup (external CSS will control most styles)
...
//     // MAGA Cap Status UI – element creation only; positioning is done via your CSS
//     this.magaCapCount = 0;
//     this.maxCaps = 5;
...
//     this.move(); // Set initial player position

//     // This will be used to store the interval ID for obstacle generation
//     this.obstacleInterval = null;
//   }

//   // Updates the life bar width and color based on current life
//   updateLifeBar() {
//     const lifePercentage = (this.currentLife / this.maxLife) * 100;
//     this.lifeBar.style.width = `${lifePercentage}%`;
//     if (lifePercentage > 50) {
//       this.lifeBar.style.backgroundColor = "#00FF00"; // Green
//     } else if (lifePercentage > 25) {
//       this.lifeBar.style.backgroundColor = "#FFFF00"; // Yellow
//     } else {
//       this.lifeBar.style.backgroundColor = "#FF0000"; // Red
//     }
//   }

//   // Decrease player energy and update life bar; if energy ≤ 0, trigger loss
//   decreaseEnergy() {
//     this.currentLife -= 10;
//     this.updateLifeBar();
//     if (this.currentLife <= 0) {
//       console.log("Game Over!");
//       this.stopGame(); // Loss scenario
//     }
//   }
...
//   // Add a MAGA cap and trigger celebration when reaching max caps
//   addMagaCap() {
...
//   // Celebration for winning (5 MAGA caps collected) – win scenario does not show the game-over banner.
//   triggerCelebration() {
...
//       this.obstacleInterval = null;
//     }
//     // Clear obstacles from game area
...
//     // Create celebration image (using trump-grit.png)
...
//     // Play celebration sound and national anthem
...
//     // Create and display dancing Trump GIF
...
//     dancingTrumpGif.style.overflow = "visible";
//     dancingTrumpGif.style.overflowClipMargin = "0";
//     dancingTrumpGif.style.display = "block";
//     dancingTrumpGif.style.objectFit = "contain";
//     document.body.appendChild(dancingTrumpGif);

//     // After 5 seconds, remove the celebration UI and call stopGameWin() to reset to start state
//     setTimeout(() => {
...
//   // Stop game for winning condition – resets the game to the start state without showing a Game Over banner.
//   stopGameWin() {
//     if (this.obstacleInterval) {
//       clearInterval(this.obstacleInterval);
//       this.obstacleInterval = null;
//     }
//     // Clear obstacles from the game area
//     document.getElementById("game-area").innerHTML = "";
//     console.log("Game Won!");
//     // Show the start button so the player can restart
